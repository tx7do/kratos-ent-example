...
const file_common_conf_logger_proto_rawDesc = "" +
	...
	"\n" +
	"access_key\x18\x03 \x01(\tR\taccessKey\x12#\n" +
	"\raccess_secret\x18\x04 \x01(\tR\faccessSecretB\x96\x01\n" +
	"\x0fcom.common.confB\vLoggerProtoP\x01Z)kratos-ent-example/api/gen/go/common/conf\xa2\x02\x03CCX\xaa\x02\vCommon.Conf\xca\x02\vCommon\\Conf\xe2\x02\x17Common\\Conf\\GPBMetadata\xea\x02\fCommon::Confb\x06proto3"
