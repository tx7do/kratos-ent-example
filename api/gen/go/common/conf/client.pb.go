...
const file_common_conf_client_proto_rawDesc = "" +
	...
	"middleware\x18\x02 \x01(\v2\x17.common.conf.MiddlewareR\n" +
	"middlewareB\x96\x01\n" +
	"\x0fcom.common.confB\vClientProtoP\x01Z)kratos-ent-example/api/gen/go/common/conf\xa2\x02\x03CCX\xaa\x02\vCommon.Conf\xca\x02\vCommon\\Conf\xe2\x02\x17Common\\Conf\\GPBMetadata\xea\x02\fCommon::Confb\x06proto3"
