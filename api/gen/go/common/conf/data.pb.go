...
const file_common_conf_data_proto_rawDesc = "" +
	"\n" +
	"\x16common/conf/data.proto\x12\vcommon.conf\x1a\x1egoogle/protobuf/duration.proto\"\x9b\x05\n" +
	"\x04Data\x126\n" +
	"\bdatabase\x18\x01 \x01(\v2\x1a.common.conf.Data.DatabaseR\bdatabase\x12-\n" +
	"\x05redis\x18\x02 \x01(\v2\x17.common.conf.Data.RedisR\x05redis\x1a\x8b\x02\n" +
	"\bDatabase\x12\x16\n" +
	"\x06driver\x18\x01 \x01(\tR\x06driver\x12\x16\n" +
	"\x06source\x18\x02 \x01(\tR\x06source\x12\x18\n" +
	"\amigrate\x18\x03 \x01(\bR\amigrate\x120\n" +
	"\x14max_idle_connections\x18\x04 \x01(\x05R\x12maxIdleConnections\x120\n" +
	"\x14max_open_connections\x18\x05 \x01(\x05R\x12maxOpenConnections\x12Q\n" +
	"\x17connection_max_lifetime\x18\x06 \x01(\v2\x19.google.protobuf.DurationR\x15connectionMaxLifetime\x1a\x9d\x02\n" +
	"\x05Redis\x12\x18\n" +
	...
	"\rwrite_timeout\x18\a \x01(\v2\x19.google.protobuf.DurationR\fwriteTimeoutB\x94\x01\n" +
	"\x0fcom.common.confB\tDataProtoP\x01Z)kratos-ent-example/api/gen/go/common/conf\xa2\x02\x03CCX\xaa\x02\vCommon.Conf\xca\x02\vCommon\\Conf\xe2\x02\x17Common\\Conf\\GPBMetadata\xea\x02\fCommon::Confb\x06proto3"
