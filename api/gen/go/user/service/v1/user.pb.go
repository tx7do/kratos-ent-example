...
const file_user_service_v1_user_proto_rawDesc = "" +
	...
	"\n" +
	"DeleteUser\x12\".user.service.v1.DeleteUserRequest\x1a\x16.google.protobuf.Empty\"\x13\x82\xd3\xe4\x93\x02\r*\v/users/{id}B\xb7\x01\n" +
	"\x13com.user.service.v1B\tUserProtoP\x01Z7kratos-ent-example/api/gen/go/user/service/v1;servicev1\xa2\x02\x03USX\xaa\x02\x0fUser.Service.V1\xca\x02\x0fUser\\Service\\V1\xe2\x02\x1bUser\\Service\\V1\\GPBMetadata\xea\x02\x11User::Service::V1b\x06proto3"
